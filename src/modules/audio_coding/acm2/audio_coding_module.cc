...
void AudioCodingModuleImpl::GetLatestDecodedAudioFrameTimestamp(int64_t& timestamp_ms,
                                                            int64_t& decode_clock_ms) {
  receiver_.GetLatestDecodedAudioFrameTimestamp(timestamp_ms, decode_clock_ms);
}
