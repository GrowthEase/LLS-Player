...
class NetEq {
 public:
  struct Config {
    ...
    size_t max_packets_in_buffer = 1500;//200;
    int max_delay_ms = 15000;//0;
    int min_delay_ms = 0;
  ...
  // Get Latest decoded audio frame timestamp and decode time
  virtual void GetLatestDecodedAudioFrameTimestamp(int64_t& timestamp_ms, int64_t& decode_clock_ms) = 0;
};
