...
class WebRtcVoiceEngine final : public VoiceEngineInterface {
 ...
 private:
  ...
  size_t audio_jitter_buffer_max_packets_ = 15000;
...
class WebRtcVoiceMediaChannel final : public VoiceMediaChannel,
 ...
 public:
  ...
  bool SetRecvParameters(const AudioRecvParameters& params, bool update = false) override;
 ...
 private:
  ...
  bool UpdateRecvCodecs(const std::vector<AudioCodec>& codecs);
